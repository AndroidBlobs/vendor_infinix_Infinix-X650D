...
#BSP:modify KCEGHLYQ-38 by shiyu.xu 20190516 start
BOOT_LOGO = hdplus1600
#BSP:modify KCEGHLYQ-38 by shiyu.xu 20190516 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-X650D-H6113-K
...
#ITD: add custom macro by huanyu.ye 20190515 start
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_TRAN_PCBA = tran_pcba_h6113
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw sp250a_mipi_raw gc2375h_mipi_raw gc6153_serial_yuv pblcs5k3l6_mipi_raw pblcs5k3l6ext2_mipi_raw pblcgc8034_mipi_raw pblcgc8034ext2_mipi_raw pblcsp250a_mipi_raw pblcgc2375h_mipi_raw pblcgc6153_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201563 s5k3l6_17201562 gc8034_17201572 gc8034_17201575 sp250a_17201564 gc2375h_17201591 gc6153_17201581
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc6153_serial_yuv
CUSTOM_HAL_LENS = dw9718saf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = sp250a_mipi_raw gc2375h_mipi_raw
...
#ITD: add custom macro by huanyu.ye 20190515 end
...
#BSP: add KCEGHLYQ-44 by changliang.guo 20190725 start
...
#BSP: add KCEGHLYQ-44 by changliang.guo 20190725 end
CUSTOM_KERNEL_HEADSET = accdet
#ITD: add custom macro by huanyu.ye 20190515 start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw sp250a_mipi_raw gc2375h_mipi_raw gc6153_serial_yuv
...
#TSD:add KCEGHLYQ-50 by ang.gu 20190514 start
CUSTOM_MODEM=x650d_h6113_k1
#TSD:add KCEGHLYQ-50 by ang.gu 20190514 end
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
#BSP:modify KCEGHLYQ-38 by shiyu.xu 20190508 start
LCM_HEIGHT = 1600
LCM_WIDTH = 720
#BSP:modify KCEGHLYQ-38 by shiyu.xu 20190508 end
...
#BSP:modify KCEGHLYQ-57 by yong.guo 20190516 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify KCEGHLYQ-57 by yong.guo 20190516 end
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_RAW_SUPPORT = yes
#modify KCEGHLYQ-40 by yong.guo 20190514 start
MTK_AUDIO_SPEAKER_PATH = int_lo_buf
#modify KCEGHLYQ-40 by yong.guo 20190514 end
...
/*BSP: modify XLWLDHLYYS-94 by yong.guo 20190822 start*/
MTK_BESLOUDNESS_SUPPORT = no
/*BSP: modify XLWLDHLYYS-94 by yong.guo 20190822 end*/
...
#ITD: modify KCSGHLYYL-76 by shoufeng.zhao for Close HDR 20190619 start
MTK_CAM_ZSDHDR_SUPPORT = no
#ITD: modify KCSGHLYYL-76 by shoufeng.zhao for Close HDR 20190619 end
...
#BSP:modify KCEGHLYQ-43 by ronghe.cheng 20190513 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:modify KCEGHLYQ-43 by ronghe.cheng 20190513 end
...
# BSP:Modify KCEGHLYQ-52 by fengshan.wang 20190515 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP:Modify KCEGHLYQ-52 by fengshan.wang 20190515 end
...
#TSD:add KCEGHLYQ-50 by ang.gu 20190520 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#TSD:add KCEGHLYQ-50 by ang.gu 20190520 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP: Modify KCEGHLYQ-41 by kun.liu 20190513 start
MTK_UART_USB_SWITCH = yes
#BSP: Modify KCEGHLYQ-41 by kun.liu 20190513 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#BSP:modify KCEGHLYQ-57 by yong.guo 20190516 end
#BSP:add XLWLDHLYYS-67 by yong.guo 20190819 start
TRAN_DIRAC_PROP_SUPPORT = yes
#BSP:add XLWLDHLYYS-67 by yong.guo 20190819 end
#BSP:add XLWLDHLYYS-109 by yong.guo 20190826 start
TRAN_VOIP_BYPASS_DIRAC = yes
#BSP:add XLWLDHLYYS-109 by yong.guo 20190826 end
#BSP: add KCEGHLYQ-46 by yong.jiang 20190513 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee chipone_tee
#BSP: add KCEGHLYQ-46 by yong.jiang 20190513 end
#BSP: add custom macro by wanghanfeng 20190507 start
#SID: add XLWLDHLYYS-1 lijia.chen 2019.07.29 start
MTK_BUILD_VERNO=X650D-H6113KLN-P-191228V126
FINGERPRINT_BUILD_VERNO=KLN-191228V126
#SID: add XLWLDHLYYS-1 lijia.chen 2019.07.29 end
TRAN_SYSTEM_DEVINFO = yes
CUSTOM_TRAN_PROJECT=tran_x650d
CUSTOM_TRAN_BOM=tran_x650d_k1
...
#BSP: add custom macro by wanghanfeng 20190507 end
# BSP: add KCEGHLYQ-56 by zhengbo.tang 20190516 start
TRAN_TP_SUPPORT = yes
# BSP: add KCEGHLYQ-56 by zhengbo.tang 20190516 end
...
#ITD:add KCEGHLYQ-120 by yang.li3 20190311 start
TRAN_FLASH_SLIDE_CONTROL=yes
#ITD:add KCEGHLYQ-120 by yang.li3 20190311 end
...
#ITD:add for CAM_SKIN_COMPATIBLE by desuo.lu 20190822 start
TRAN_CAM_SKIN_COMPATIBLE = yes
#ITD:add for CAM_SKIN_COMPATIBLE by desuo.lu 20190822 end
...
###################Skynet End#######################
#BSP: modify KCSGHLYYL-1758 by tao.lan 20191024 start
TRAN_PS_CALI_FAC = yes
#BSP: modify KCSGHLYYL-1758 by tao.lan 20191024 end
